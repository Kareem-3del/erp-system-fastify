...
describe('Authentication-Plugin', () => {
    ...
    it('should return unauthorized error if not authenticated', async () => {
        app.get('/protected', { preValidation: [app.authenticate] }, async (_request:FastifyRequest, _reply:FastifyReply) => {
    ...
    it('should not return unauthorized error if authenticated', async () => {
        app.get('/not-protected', { preValidation: [] }, async (_request:FastifyRequest, _reply:FastifyReply) => {
            return { message: 'You have access to this protected route!' };
        });
